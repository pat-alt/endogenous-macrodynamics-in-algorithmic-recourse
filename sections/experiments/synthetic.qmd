...
www_paper_path = mkpath("paper/www/appendix/synthetic/")
...
### Animated GIFs for Presentation
...
EMAR.aggregate_bs_synthetic(backend=Val(:html))
```
...
### Chart in paper (Figure 3) {#sec-app-synthetic-paper}
...
using DataFrames, Statistics, RCall
...
ggsave(temp_path, width=$ncol * $scale_,height=$nrow * $scale_ * 0.75, dpi=300) 
"""
