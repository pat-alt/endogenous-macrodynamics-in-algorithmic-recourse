...
EMAR.aggregate_bs_mitigation_synthetic(backend=Val(:html))
```
...
EMAR.aggregate_bs_mitigation_real_world(backend=Val(:html))
```
...
df = EMAR.aggregate_bs_mitigation_latent(backend = Val(:html))
```
